...
define(function (require) {
    ...
    var resultsApp = angular.module('resultsApp', [
        ...
        $translateProvider.translations('en', {
            ...
            'DETAILS_HIDE': '- Hide ',
            'DETAILS_SHOW': '+ Show ',
            'DISCOVERY_CREDIT': 'Based on UBC Open Collections',
            ...
            'ERROR_GENERAL': 'There has been an error. Please refresh the page or use the back button to try a new search.',
            'FACET': 'Facet',
        ...
        $translateProvider.translations('fr', {
            ...
            'DISCOVERY_CREDIT': 'Basé sur UBC Open Collections',
            'DRILL_DOWN': 'Percer',
            ...
            'ERROR_NO_RESULTS': 'Cette recherche n\'a retourné aucune correspondance. Vous pouvez entrer une requête différente, modifier vos filtres ou essayer une recherche avancée.',
