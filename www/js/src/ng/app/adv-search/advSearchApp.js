define(function(require){
    ...
    var advSearchApp = angular.module('advSearchApp',[
        ...
        $translateProvider.translations('en', {
            ...
            'REPOLIST_BLURB': 'This is the list of research data repositories currently included in the discovery results',
        ...
        $translateProvider.translations('fr', {
            ...
            'REPOLIST_BLURB': 'Voici la liste des référentiels de données de recherche actuellement inclus dans les résultats de la découverte',
