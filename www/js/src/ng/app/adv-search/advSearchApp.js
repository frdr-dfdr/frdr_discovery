define(function(require){
    ...
    var advSearchApp = angular.module('advSearchApp',[
        ...
        $translateProvider.translations('en', {
            ...
            'FOOTER_ALLIANCE': 'Digital Research Alliance of Canada',
            'FOOTER_ALLIANCE_LOGO': '/static/images/latest/logos/alliance_logo.svg',
            'FOOTER_ALLIANCE_URL': 'https://alliancecan.ca/',
            'FOOTER_DISCLAIMER': 'Digital Research Alliance of Canada respects the privacy of individuals and will only collect, use, and disclose personal information in keeping with information access and privacy law.',
            'IN':'in',
            ...
            'MENU_LOCALE': 'EN',
            'MENU_SITE_METRICS': 'Site Metrics',
            'MENU_SITE_METRICS_URL': '/stats/en',
            'MENU_LOCALE': 'EN',
            'NOT': 'NOT',
            'OR': 'OR',
        ...
        $translateProvider.translations('fr', {
            ...
            'MENU_HELP_VIDEOS_URL': 'https://www.youtube.com/watch?v=U4Qaia4KZAU&list=PLX9EpizS4A0suoSV2N0nn9parl96xHPkz',
            'MENU_LOCALE': 'FR',
            'MENU_SITE_METRICS': 'Métriques du site',
            'MENU_SITE_METRICS_URL': '/stats/fr',
            'NOT': 'Sauf',
            'OR': 'Ou',
